 ...
 */
export class SimpleJavaScriptAnalyzer {
  ...
  private getFileType(filePath: string): 'javascript' | 'typescript' | 'jsx' | 'tsx' {
  ...
  private analyzeLineForFeatures(line: string, lineNumber: number, filePath: string, features: FeatureUsage[]): void {
